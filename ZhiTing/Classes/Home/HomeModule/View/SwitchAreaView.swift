...
class SwitchAreaView: UIView {
    ...
    var canDismiss = true {
        didSet {
            coverView.isUserInteractionEnabled = canDismiss
    ...
    private lazy var label = Label().then {
        $0.text = "切换家庭/公司".localizedString
...
extension SwitchAreaView: UITableViewDelegate, UITableViewDataSource {
