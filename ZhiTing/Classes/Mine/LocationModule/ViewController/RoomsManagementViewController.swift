...
class RoomsManagementViewController: BaseViewController {
    ...
    private lazy var addLocationButton = ImageTitleButton(frame: .zero, icon: .assets(.plus_blue), title: "添加房间".localizedString, titleColor: UIColor.custom(.blue_2da3f6), backgroundColor: UIColor.custom(.white_ffffff))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "房间管理".localizedString
...
extension RoomsManagementViewController: UITableViewDelegate, UITableViewDataSource {
...
extension RoomsManagementViewController {
