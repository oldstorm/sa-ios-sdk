...
class DeviceHumidityAttrAlert: UIView, DeviceAttrAlert {
    ...
    convenience init(value: Int, maxValue: Int, minValue: Int, segmentTag: Int) {
        self.init(frame: CGRect(x: 0, y: 0, width: Screen.screenWidth, height: Screen.screenHeight))
        titleLabel.text = "湿度".localizedString
        currentValue = value
        setupSensorHumiditySlider(value: value, maxValue: maxValue, minValue: minValue, segmentTag: segmentTag)
...
extension DeviceHumidityAttrAlert {
...
extension DeviceHumidityAttrAlert: UIGestureRecognizerDelegate{
