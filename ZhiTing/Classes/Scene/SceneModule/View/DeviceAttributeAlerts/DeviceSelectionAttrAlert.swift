...
protocol DeviceAttrAlert {}


class DeviceSelectionAttrAlert: UIView, DeviceAttrAlert {
    ...
    convenience init(title: String, datas: [Item]){
...
// MARK: - 选项相关方法
extension DeviceSelectionAttrAlert {
...
extension DeviceSelectionAttrAlert: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.isUserInteractionEnabled = item.enable
        cell.contentView.alpha = item.enable ? 1 : 0.5
