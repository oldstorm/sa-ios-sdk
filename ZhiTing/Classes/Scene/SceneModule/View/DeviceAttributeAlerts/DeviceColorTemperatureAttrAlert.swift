//
//  DeviceColorTemperatureAttrAlert.swift
//  ZhiTing
//
...
class DeviceColorTemperatureAttrAlert: UIView, DeviceAttrAlert {
    ...
    convenience init(value: Int, maxValue: Int, minValue: Int, segmentTag: Int) {
        ...
        titleLabel.text = "色温".localizedString
        currentValue = value
...
extension DeviceColorTemperatureAttrAlert {
...
extension DeviceColorTemperatureAttrAlert: UIGestureRecognizerDelegate{
