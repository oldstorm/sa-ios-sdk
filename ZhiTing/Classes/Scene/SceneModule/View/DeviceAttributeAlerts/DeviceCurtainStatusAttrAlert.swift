//
//  DeviceCurtainStatusAttrAlert.swift
//  ZhiTing
//
...
class DeviceCurtainStatusAttrAlert: UIView, DeviceAttrAlert {
    ...
    convenience init(value: Int, maxValue: Int, minValue: Int, segmentTag: Int) {
        ...
        titleLabel.text = "窗帘位置".localizedString
        currentValue = value
...
extension DeviceCurtainStatusAttrAlert {
...
extension DeviceCurtainStatusAttrAlert: UIGestureRecognizerDelegate{
