//
//  DeviceBrightnessAttrAlert.swift
//  ZhiTing
//
...
class DeviceBrightnessAttrAlert: UIView, DeviceAttrAlert {
    ...
    convenience init(value: Int, maxValue: Int, minValue: Int, segmentTag: Int) {
        ...
        titleLabel.text = "亮度".localizedString
        currentValue = value
...
extension DeviceBrightnessAttrAlert {
...
extension DeviceBrightnessAttrAlert: UIGestureRecognizerDelegate{
